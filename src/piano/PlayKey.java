...
public class PlayKey {
	...
	public synchronized void playSound(String octave, String str) throws FileNotFoundException, UnsupportedAudioFileException, IOException, LineUnavailableException {
